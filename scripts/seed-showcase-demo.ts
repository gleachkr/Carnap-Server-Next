/**
 * Seed the showcase lesson — one assignment holding every exercise type, each
 * next to the source that produced it — onto a running LOCAL dev server
 ...
 * course, authors the lesson as a content revision, and publishes it as a
 * practice assignment. Prints the URLs to open.
 *
 *   bun run dev            # in another terminal
 *   bun run scripts/seed-showcase-demo.ts
 *
